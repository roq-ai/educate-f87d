...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Students'];
  const customerRoles: string[] = [];
  const tenantRoles: string[] = ['Healthcare Professional', 'Medical Educator', 'Emergency Responder', 'Students'];
  const addOns: string[] = ['notifications', 'file'];
  const applicationName = `Educate`;
  const tenantName = `Public`;
